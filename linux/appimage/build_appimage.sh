...
mkdir -p "Planner123.AppDir"
cp -r ../appimage_deb/data/usr "Planner123.AppDir"

cd "Planner123.AppDir"
mkdir -p "usr/bin"
mkdir -p "usr/lib"
...
( cd "/home/pvd/.cache/tauri" && ( wget -q -4 -N https://github.com/AppImage/AppImageKit/releases/download/continuous/AppRun-${ARCH} || wget -q -4 -N https://github.com/AppImage/AppImageKit/releases/download/12/AppRun-${ARCH} ) )
chmod +x "/home/pvd/.cache/tauri/AppRun-${ARCH}"

# We need AppRun to be installed as Planner123.AppDir/AppRun.
# Otherwise the linuxdeploy scripts will default to symlinking our main bin instead and will crash on trying to launch.
cp "/home/pvd/.cache/tauri/AppRun-${ARCH}" AppRun

cp "usr/share/icons/hicolor/512x512/apps/planner123-app.png" .DirIcon
ln -sf "usr/share/icons/hicolor/512x512/apps/planner123-app.png" "Planner123.png"

ln -sf "usr/share/applications/Planner123.desktop" "Planner123.desktop"
...
( cd "/home/pvd/.cache/tauri" && wget -q -4 -N https://raw.githubusercontent.com/tauri-apps/linuxdeploy-plugin-gtk/master/linuxdeploy-plugin-gtk.sh )
( cd "/home/pvd/.cache/tauri" && wget -q -4 -N https://github.com/tauri-apps/binary-releases/releases/download/linuxdeploy/linuxdeploy-${linuxdeploy_arch}.AppImage )

chmod +x "/home/pvd/.cache/tauri/linuxdeploy-plugin-gtk.sh"
chmod +x "/home/pvd/.cache/tauri/linuxdeploy-${linuxdeploy_arch}.AppImage"

dd if=/dev/zero bs=1 count=3 seek=8 conv=notrunc of="/home/pvd/.cache/tauri/linuxdeploy-${linuxdeploy_arch}.AppImage"

OUTPUT="Planner123_0.1.34_amd64.AppImage" "/home/pvd/.cache/tauri/linuxdeploy-${linuxdeploy_arch}.AppImage" --appimage-extract-and-run --appdir "Planner123.AppDir" --plugin gtk ${gst_plugin} --output appimage
